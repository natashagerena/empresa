...
$acf_options->set_field('image', 'Logo rodapé', 'logo_footer');
...
// $acf_options->set_field('google_map', 'Mapa', 'mapa');
...
// Fields
$acf_options_add->set_field('qtranslate_textarea', 'Texto Produtos', 'texto_produtos');
